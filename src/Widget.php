 ...
 *
 * @link https://github.com/hongyukeji/yii2-imperavi-widget
 * @link http://imperavi.com/redactor
 * @license https://github.com/hongyukeji/yii2-imperavi-widget/blob/master/LICENSE.md
 */
class Widget extends BaseWidget
{
    /** Name of inline JavaScript package that is registered by the widget */
    const INLINE_JS_KEY = 'hongyukeji/imperavi/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['hongyukeji/imperavi']) && !isset(Yii::$app->i18n->translations['hongyukeji/imperavi/*'])) {
            Yii::$app->i18n->translations['hongyukeji/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@hongyukeji/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'hongyukeji/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
