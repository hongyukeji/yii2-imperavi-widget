...
namespace hongyukeji\imperavi\actions;
...
use hongyukeji\imperavi\helpers\FileHelper;

/**
 * Class GetAction
 * @package hongyukeji\imperavi\actions
 *
...
class GetAction extends Action
{
    ...
    /**
     * [\hongyukeji\imperavi\helpers\FileHelper::findFiles()|FileHelper::findFiles()] options argument.
     * @var array Options
     */
    public $options = [];
